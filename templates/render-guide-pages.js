...
function renderIndex() {
  const cards = guides.map((guide) => `<a class="guide-card" href="guides/${guide.slug}.html"><small>${esc(guide.primaryQuery)}</small><strong>${esc(guide.h1)}</strong><span>${esc(guide.description)}</span><em>Read guide &rarr;</em></a>`).join("");
  const schema = {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
...
<body>
${nav("")}
<main class="shell"><div class="breadcrumb"><a href="index.html">Home</a> &gt; Guides</div><header class="index-hero"><h1>Choose The Right Tool, Then Read The Result Carefully</h1><p>These guides separate look-alike calculations and self-checks, explain what each method can answer, and route you to the smallest useful next step.</p></header><div class="guide-grid">${cards}</div><div class="disclaimer">Guides are educational and evidence-informed. They do not replace medical, mental health, nutrition, or relationship support from a qualified professional.</div></main>
${footer("")}
</body>
</html>`;
}
