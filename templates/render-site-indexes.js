...
function homeRedesignStyles() {
  return `.container{max-width:1280px;margin-top:26px}.tool-card,.e-e-a-t-section{border-radius:8px}.navbar{background:white;padding:15px max(20px,5%);display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid #e2e8f0;position:sticky;top:0;z-index:10}.logo{font-size:22px;font-weight:850;color:var(--accent);text-decoration:none}.nav-links{display:flex;gap:24px}.nav-links a{text-decoration:none;color:#4b5563;font-weight:700;font-size:14px}.hero{display:grid;grid-template-columns:minmax(0,1fr) 420px;gap:34px;align-items:center;margin:0 0 28px;padding:20px 0 28px;border-bottom:1px solid #dbe2ea}.hero-copy{max-width:760px}.hero-kicker{color:#047857;font-size:.78rem;font-weight:850;text-transform:uppercase;margin-bottom:10px}.hero h1{font-size:3rem;font-weight:850;letter-spacing:0;line-height:1.07;margin-bottom:16px;color:#0f172a}.hero p{color:var(--text-muted);font-size:1.05rem;max-width:720px}.hero-actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:20px}.hero-actions a{border:1px solid #cbd5e1;border-radius:8px;padding:9px 12px;text-decoration:none;color:#1e293b;font-weight:800;font-size:.86rem;background:#fff}.hero-actions a:first-child{background:#0f172a;color:#fff;border-color:#0f172a}.hero-actions a:hover,.hero-actions a:focus-visible{border-color:var(--accent);outline:none}.hero-visual{background:#fff;border:1px solid #dbe2ea;border-radius:8px;padding:20px;box-shadow:0 18px 38px rgba(15,23,42,.08);display:grid;gap:14px}.hero-visual-header small{display:block;color:#7c3aed;font-size:.76rem;font-weight:850;text-transform:uppercase;margin-bottom:5px}.hero-visual-header h2{font-size:1.25rem;line-height:1.22;color:#0f172a;margin-bottom:6px}.hero-visual-header p{font-size:.9rem;line-height:1.5;color:var(--text-muted)}.feature-links{display:grid;gap:10px}.feature-link{display:grid;grid-template-columns:44px minmax(0,1fr);gap:12px;align-items:start;border:1px solid #dbe2ea;border-radius:8px;padding:13px;text-decoration:none;color:inherit;background:#f8fafc}.feature-link:hover,.feature-link:focus-visible{background:#eff6ff;border-color:var(--accent);outline:none}.feature-index{display:grid;place-items:center;width:36px;height:36px;border-radius:8px;background:#0f172a;color:#fff;font-size:.78rem;font-weight:850}.feature-link strong{display:block;color:#1e293b;font-size:1rem;line-height:1.25}.feature-link span{display:block;color:var(--text-muted);font-size:.86rem;line-height:1.42;margin-top:3px}.feature-link em{display:block;color:var(--accent);font-style:normal;font-size:.78rem;font-weight:850;margin-top:7px}.proof-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;border-top:1px solid #e2e8f0;padding-top:12px}.proof-row span{font-size:.82rem;font-weight:780;color:#047857;background:#ecfdf5;border:1px solid #bbf7d0;border-radius:8px;padding:8px 10px}.trust-badges{display:flex;gap:10px;margin-top:18px;color:#047857;font-weight:760;font-size:.84rem;flex-wrap:wrap}.trust-badges span{background:#ecfdf5;border:1px solid #bbf7d0;border-radius:8px;padding:6px 9px}.search-wrapper{max-width:880px;margin:0 0 24px;position:relative}.search-input{width:100%;padding:16px 20px;border:2px solid #cbd5e1;border-radius:8px;font-size:16px;background:white}.search-input:focus{border-color:var(--accent);outline:none;box-shadow:0 0 0 4px var(--accent-light)}.search-results{display:none;position:absolute;left:0;right:0;top:calc(100% + 8px);z-index:20;background:white;border:1px solid #cbd5e1;border-radius:8px;box-shadow:0 18px 35px rgba(15,23,42,.14);overflow:hidden}.search-results.is-open{display:block}.search-result{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:2px 18px;padding:13px 16px;border-bottom:1px solid #eef2f7;text-decoration:none;color:inherit}.search-result:last-child{border-bottom:none}.search-result:hover,.search-result:focus-visible{background:#eff6ff;outline:none}.search-result strong{font-size:14px;color:#1e293b}.search-result span{grid-row:1 / 3;grid-column:2;color:var(--accent);font-size:12px;font-weight:800;align-self:center}.search-result small{font-size:12px;color:var(--text-muted)}.search-empty{padding:16px;color:var(--text-muted);font-size:14px}.route-section{padding:20px 0 34px}.route-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.route-card{display:flex;flex-direction:column;gap:8px;min-height:172px;background:#fff;border:1px solid #dbe2ea;border-radius:8px;padding:18px;text-decoration:none;color:inherit}.route-card:hover,.route-card:focus-visible{border-color:var(--accent);box-shadow:0 16px 30px rgba(37,99,235,.08);outline:none}.route-card small{color:#7c3aed;font-size:.72rem;font-weight:850;text-transform:uppercase}.route-card strong{color:#1e293b;font-size:1rem;line-height:1.25}.route-card span{color:var(--text-muted);font-size:.86rem;line-height:1.45}.route-card em{margin-top:auto;color:var(--accent);font-style:normal;font-size:.8rem;font-weight:850}.format-band{padding:28px 0 32px;border-top:1px solid #cbd5e1}.format-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.format-item{border-top:3px solid #cbd5e1;padding-top:16px}.format-item h2{font-size:1.05rem;margin-bottom:6px}.format-item p{font-size:.88rem;color:var(--text-muted);line-height:1.55;margin-bottom:10px}.format-item a{font-size:.82rem;color:var(--accent);font-weight:800;text-decoration:none}.format-item:hover{border-color:var(--accent)}.category-band{padding:28px 0 34px;border-top:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0}.section-heading{display:flex;justify-content:space-between;align-items:end;gap:20px;margin-bottom:16px}.section-heading h2{font-size:1.35rem;line-height:1.25}.section-heading p{font-size:.9rem;color:var(--text-muted)}.category-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.category-link{padding:20px 0;text-decoration:none;color:inherit;border-top:3px solid #cbd5e1}.category-link:hover,.category-link:focus-visible{border-color:var(--accent);outline:none}.category-link span{font-size:1.05rem;font-weight:850;color:#1e293b}.category-link small{margin-left:8px;color:var(--text-muted);font-weight:750}.category-link p{color:var(--text-muted);font-size:.9rem;line-height:1.5;margin:7px 0 12px;max-width:340px}.category-link strong{font-size:.82rem;color:var(--accent)}.popular-section{padding-top:38px}.popular-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:18px}.popular-grid .tool-card{padding:22px;min-height:220px}.popular-grid .tool-name{font-size:1.03rem}.popular-grid .tool-desc{font-size:.88rem}.directory-section{padding-top:54px}.directory-list{border-bottom:1px solid #cbd5e1}.directory-group{display:grid;grid-template-columns:230px minmax(0,1fr);gap:34px;padding:28px 0;border-top:1px solid #cbd5e1}.directory-intro h3{font-size:1.12rem;line-height:1.3}.directory-intro h3 a{color:#1e293b;text-decoration:none}.directory-intro h3 a:hover,.directory-intro h3 a:focus-visible{color:var(--accent)}.directory-intro p{font-size:.85rem;color:var(--text-muted);line-height:1.55;margin:8px 0 12px}.directory-category-link{font-size:.8rem;color:var(--accent);font-weight:800;text-decoration:none}.directory-topics{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:26px}.directory-topic h4{font-size:.82rem;color:#475569;margin-bottom:9px}.directory-topic ul{list-style:none;display:grid;gap:7px}.directory-topic a{color:#1e293b;text-decoration:none;font-size:.88rem;font-weight:700}.directory-topic a:hover,.directory-topic a:focus-visible{color:var(--accent);text-decoration:underline}.home-guides{margin-top:54px;padding:34px 0;border-top:1px solid #cbd5e1}.home-guides .section-heading a{color:var(--accent);font-weight:800;text-decoration:none}.home-guide-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.home-guide{background:#fff;border:1px solid #dbe2ea;border-radius:8px;padding:20px;text-decoration:none;color:inherit;min-height:180px}.home-guide:hover,.home-guide:focus-visible{border-color:var(--accent);outline:none}.home-guide small{display:block;color:#047857;font-size:.72rem;font-weight:850;text-transform:uppercase}.home-guide strong{display:block;color:#1e293b;font-size:1.02rem;margin-top:7px}.home-guide span{display:block;color:var(--text-muted);font-size:.85rem;line-height:1.55;margin-top:7px}.home-guide em{display:block;color:var(--accent);font-style:normal;font-size:.8rem;font-weight:800;margin-top:12px}.quality-section{margin-top:54px;padding:34px 0;border-top:1px solid #cbd5e1;border-bottom:1px solid #cbd5e1}.quality-intro{max-width:760px;margin-bottom:24px}.quality-intro h2{font-size:1.35rem;margin-bottom:7px}.quality-intro p{font-size:.92rem;color:var(--text-muted)}.quality-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:34px}.quality-item h3{font-size:1rem;margin-bottom:7px}.quality-item p{font-size:.88rem;color:var(--text-muted);line-height:1.6}.quality-item a{color:var(--accent);font-weight:800}.quality-meta{display:flex;gap:12px 24px;flex-wrap:wrap;margin-top:25px;padding-top:18px;border-top:1px solid #e2e8f0;color:#475569;font-size:.78rem;font-weight:750}@media(max-width:1120px){.hero{grid-template-columns:1fr}.hero-visual{max-width:620px}.route-grid,.category-grid,.popular-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.directory-group{grid-template-columns:190px minmax(0,1fr)}}@media(max-width:820px){.directory-group{grid-template-columns:1fr}.directory-intro{max-width:620px}.directory-topics{grid-template-columns:repeat(2,minmax(0,1fr))}.quality-grid{grid-template-columns:1fr;gap:22px}}@media(max-width:768px){.container{margin-top:20px}.navbar{align-items:flex-start;gap:12px;flex-direction:column}.nav-links{gap:14px;flex-wrap:wrap}.hero{padding-top:4px}.hero h1{font-size:2.15rem}.proof-row{grid-template-columns:1fr}.route-grid,.format-grid,.category-grid,.popular-grid,.directory-topics,.home-guide-grid{grid-template-columns:1fr}.section-heading{align-items:flex-start;flex-direction:column;gap:4px}.search-result{grid-template-columns:minmax(0,1fr)}.search-result span{grid-row:auto;grid-column:auto}.popular-grid .tool-card,.home-guide{min-height:0}}`;
}

function homeSidebarStyles() {
  return `.home-layout{display:grid;grid-template-columns:230px minmax(0,1fr) 230px;gap:24px;align-items:start}.home-main{min-width:0}.home-rail{position:sticky;top:84px;display:grid;gap:16px}.rail-panel{background:#fff;border:1px solid #dbe2ea;border-radius:8px;padding:16px}.rail-panel h2{font-size:.95rem;line-height:1.25;margin-bottom:10px;color:#0f172a}.rail-panel p{font-size:.82rem;color:var(--text-muted);line-height:1.5;margin-bottom:12px}.rail-list{display:grid;gap:8px}.rail-link{display:block;text-decoration:none;color:inherit;border-left:3px solid #cbd5e1;padding:8px 0 8px 10px}.rail-link:hover,.rail-link:focus-visible{border-color:var(--accent);outline:none;background:#f8fafc}.rail-link small{display:block;color:#7c3aed;font-size:.68rem;font-weight:850;text-transform:uppercase}.rail-link strong{display:block;color:#1e293b;font-size:.88rem;line-height:1.25;margin-top:2px}.rail-link span{display:block;color:var(--text-muted);font-size:.76rem;line-height:1.35;margin-top:3px}.rail-pill-list{display:flex;gap:7px;flex-wrap:wrap}.rail-pill{border:1px solid #cbd5e1;border-radius:8px;padding:6px 8px;color:#334155;text-decoration:none;font-size:.76rem;font-weight:800;background:#f8fafc}.rail-pill:hover,.rail-pill:focus-visible{border-color:var(--accent);background:#eff6ff;outline:none}.rail-proof{display:grid;gap:8px}.rail-proof span{font-size:.78rem;font-weight:780;color:#047857;background:#ecfdf5;border:1px solid #bbf7d0;border-radius:8px;padding:8px}.home-layout .route-grid,.home-layout .popular-grid,.home-layout .category-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.home-layout .format-grid{grid-template-columns:1fr}.home-layout .popular-grid .tool-card{min-height:205px}.home-layout .quality-grid{grid-template-columns:1fr;gap:18px}@media(max-width:1180px){.home-layout{grid-template-columns:1fr}.home-rail{position:static;grid-template-columns:repeat(2,minmax(0,1fr));order:-1}.home-main{order:1}.home-rail-right{order:2}.home-layout .format-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:768px){.home-rail{grid-template-columns:1fr}.home-layout .route-grid,.home-layout .popular-grid,.home-layout .category-grid,.home-layout .format-grid{grid-template-columns:1fr}.rail-panel{padding:14px}}`;
}
...
function renderHome() {
  ...
  const priorityTools = [
    ["Search data", "BMI Calculator", "Highest current impressions; adult category, formula, and limits.", "tools/bmi-calculator.html"],
    ["Search data", "Calorie Calculator", "Maintenance, loss, or gain target with visible adjustment.", "tools/calorie-calculator.html"],
    ["Search data", "Daily Steps Goal", "Build a walking routine from current baseline and timeline.", "tools/daily-steps-goal-calculator.html"],
    ["Search data", "BMR Calculator", "Resting-energy estimate before activity is added.", "tools/bmr-calculator.html"],
    ["Search data", "TDEE Calculator", "Maintenance calories by activity level and calibration steps.", "tools/tdee-calculator.html"]
  ].map(([label, title, body, href]) => `<a class="rail-link" href="${href}" data-source="left-rail"><small>${esc(label)}</small><strong>${esc(title)}</strong><span>${esc(body)}</span></a>`).join("");
  const decisionShortcuts = [
    ["New hub", "Body Metrics & Calorie Planning", "Choose the right body, energy, activity, or trend tool.", "guides/body-metrics-calorie-planning-tools.html"],
    ["Compare", "BMR vs TDEE vs Calorie Goal", "Understand the sequence before choosing a target.", "guides/bmr-vs-tdee-vs-calorie-goal.html"],
    ["Sleep", "Sleep Debt vs Sleep Quality", "Separate short sleep opportunity from poor sleep quality.", "guides/sleep-debt-vs-sleep-quality.html"],
    ["Digital habits", "Smartphone vs Social Media Use", "Choose the right self-check for digital habit patterns.", "guides/smartphone-use-vs-social-media-use.html"]
  ].map(([label, title, body, href]) => `<a class="rail-link" href="${href}" data-source="right-rail"><small>${esc(label)}</small><strong>${esc(title)}</strong><span>${esc(body)}</span></a>`).join("");
...
<script>window.va=window.va||function(){(window.vaq=window.vaq||[]).push(arguments);};</script>
<script defer src="/_vercel/insights/script.js"></script>
<style>${baseStyles()}${homeRedesignStyles()}${homeSidebarStyles()}</style>
</head>
<body>
...
<div class="container">
    <header class="hero"><div class="hero-copy"><p class="hero-kicker">Private tools for everyday decisions</p><h1>Tools For Body Metrics, Habits, Sleep, And Connection</h1><p>Use transparent calculators, original self-checks, and decision guides to turn a vague question into a clearer next step.</p><div class="hero-actions"><a href="guides.html">Explore guides</a><a href="health.html">Use calculators</a><a href="mental-health.html">Try self-checks</a></div><div class="trust-badges"><span>Transparent methods</span><span>No registration</span><span>Inputs stay in your browser</span></div></div><aside class="hero-visual" aria-labelledby="hero-visual-heading"><div class="hero-visual-header"><small>Choose a starting mode</small><h2 id="hero-visual-heading">Not sure what to open first?</h2><p>Pick the type of answer you need. Each path leads to a real tool or guide instead of a static image.</p></div><div class="feature-links"><a class="feature-link" href="health.html" data-source="hero-mode"><span class="feature-index">01</span><span><strong>I need a number</strong><span>Open calculators for calories, body metrics, sleep timing, and trends.</span><em>Browse calculators &rarr;</em></span></a><a class="feature-link" href="mental-health.html" data-source="hero-mode"><span class="feature-index">02</span><span><strong>I need a pattern check</strong><span>Use private self-checks for stress, focus, burnout, and digital habits.</span><em>Try self-checks &rarr;</em></span></a><a class="feature-link" href="guides.html" data-source="hero-mode"><span class="feature-index">03</span><span><strong>I need context</strong><span>Read guides that compare similar tools and explain next steps.</span><em>Read guides &rarr;</em></span></a></div><div class="proof-row"><span>Browser-local inputs</span><span>Method and limits shown</span></div></aside></header>
    ...
    <aside class="home-rail home-rail-left" aria-label="Priority tool entrances"><section class="rail-panel"><h2>Priority Tool Entrances</h2><p>Pages already earning impressions get stronger, persistent access from the homepage.</p><div class="rail-list">${priorityTools}</div></section><section class="rail-panel"><h2>Fast Categories</h2><div class="rail-pill-list"><a class="rail-pill" href="health.html">Health</a><a class="rail-pill" href="lifestyle.html">Lifestyle</a><a class="rail-pill" href="mental-health.html">Self-checks</a><a class="rail-pill" href="guides.html">Guides</a></div></section></aside>
    ...
    <aside class="home-rail home-rail-right" aria-label="Decision guide shortcuts"><section class="rail-panel"><h2>Decision Shortcuts</h2><p>Use these when the user needs orientation before choosing a tool.</p><div class="rail-list">${decisionShortcuts}</div></section><section class="rail-panel"><h2>Trust Signals</h2><div class="rail-proof"><span>Inputs stay in browser</span><span>Formulas and limits shown</span><span>No account required</span></div></section></aside>
    </div>
</div>
<script>
