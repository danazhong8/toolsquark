...
<div class="container">
    <header class="hero"><div class="hero-copy"><p class="hero-kicker">Private tools for everyday decisions</p><h1>Tools For Body Metrics, Habits, Sleep, And Connection</h1><p>Use transparent calculators, original self-checks, and decision guides to turn a vague question into a clearer next step.</p><div class="hero-actions"><a href="guides.html">Explore guides</a><a href="health.html">Use calculators</a><a href="mental-health.html">Try self-checks</a></div><div class="trust-badges"><span>Transparent methods</span><span>No registration</span><span>Inputs stay in your browser</span></div></div><aside class="hero-visual" aria-label="ToolsQuark trust and method overview"><img src="assets/visual-guides/home-trust-map.png" width="720" height="405" alt="A visual map showing private inputs, transparent methods, and practical next steps"><div class="hero-visual-caption"><span>Method-first tool pages</span><span>Educational, not diagnostic</span></div></aside></header>
