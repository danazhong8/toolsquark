...
function renderHome() {
  ...
  const taskCardDetails = {
    "bmi-calculator": { taskTitle: "Check your adult body-size range", theme: "body", chips: ["Metric or imperial", "Category context"] },
    "bmr-calculator": { taskTitle: "Find your resting calorie baseline", theme: "energy", chips: ["Mifflin-St Jeor", "Formula shown"] },
    "calorie-calculator": { taskTitle: "Choose a maintenance-first intake target", theme: "energy", chips: ["Deficit or surplus", "Next-step target"] },
    "tdee-calculator": { taskTitle: "Estimate your daily maintenance calories", theme: "energy", chips: ["Activity factor", "Planning baseline"] },
    "walking-time-to-steps-calculator": { taskTitle: "Turn walking minutes into step estimates", theme: "movement", chips: ["10-60 minutes", "Pace presets"] },
    "daily-steps-goal-calculator": { taskTitle: "Build a realistic step goal", theme: "movement", chips: ["Baseline first", "Gradual plan"] },
    "maintenance-calorie-calibration-calculator": { taskTitle: "Calibrate calories against real trend data", theme: "energy", chips: ["Trend check", "Adjustment logic"] },
    "sleep-consistency-calculator": { taskTitle: "See how steady your sleep timing is", theme: "sleep", chips: ["Bed/wake range", "Routine signal"] },
...
<script>window.va=window.va||function(){(window.vaq=window.vaq||[]).push(arguments);};</script>
<script defer src="/_vercel/insights/script.js"></script>
<style>${baseStyles()}${homeRedesignStyles()}${homeTaskCardStyles()}</style>
</head>
<body>
