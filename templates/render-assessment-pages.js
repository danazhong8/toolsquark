...
function renderReferences(items = []) {
  ...
  return `<div class="card reference-card"><h3>Authoritative References</h3><p class="reference-intro">These resources provide general background. They do not validate or endorse this self-check.</p><ul class="reference-list">${items.map((item) => `<li><a href="${esc(item.href)}" target="_blank" rel="noopener noreferrer">${esc(item.title)}</a><span>${esc(item.publisher)}</span></li>`).join("")}</ul></div>`;
}
...
@media(max-width:768px){.hero{padding:36px 24px}.hero h1{font-size:28px}.question{font-size:19px}.recommend-grid{grid-template-columns:1fr}.score{font-size:46px}.card{padding:22px 18px}.assessment-meta{display:grid;grid-template-columns:1fr 1fr}.quiz-actions,.result-actions{flex-wrap:wrap}.reference-list li{display:block}.reference-list span{display:block;margin-top:4px;white-space:normal}}
${config.extraCss || ""}
</style>
</head>
<body>
<div class="container">
    ...
    <footer><a href="https://toolsquark.com/privacy.html">Privacy Policy</a><span>&copy; 2026 ToolsQuark. All rights reserved.</span></footer>
</div>
<script>
